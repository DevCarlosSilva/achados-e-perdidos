    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link text-black nav-item-hover" href="index.php">Página inicial</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle nav-item-hover text-black" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="assets/blankProfile.png" alt="blank profile image" width="24">
              <?php echo $_SESSION['username']; ?>
            </a>
            <ul class="dropdown-menu bg-danger">
              <li><a class="dropdown-item bg-danger text-white" href="signInSignUpLogOut/logOut.php">Sair da conta</a></li>
            </ul>
          </li>
        </ul>
      </div>
